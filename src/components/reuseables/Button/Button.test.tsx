...
describe('Button component', () => {
	...
	it('executes clickFunc when clicked', () => {
		const clickFuncMock = jest.fn()
		render(<Button clickFunc={clickFuncMock}>Click me</Button>)
		const buttonElement = screen.getByText('Click me')
	...
	it('renders a clicked button', () => {
		render(<Button isClicked>Clicked</Button>)
	...
	it('renders a toggle button in its clicked state', () => {
		render(<Button type="toggle" isClicked>Toggle</Button>)
	...
	it('renders different width based on media query', () => {
		render(<Button width="50px" mobileWidth="100px">Width Test</Button>)
	...
	it('renders different width for round button based on media query', () => {
		render(<Button shape="round" width="100px" mobileWidth="50px">Round Width Test</Button>)
